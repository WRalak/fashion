...
const Footer: React.FC = () => {
  return (
    <footer className="font-medium py-6 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-screen-lg mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {/* Shop Section */}
          <div>
            <h3 className="text-sm text-gray-600 mb-3">SHOP</h3>
          ...
          <div>
            <h3 className="text-sm text-gray-500 mb-3">CUSTOMER SERVICE</h3>
          ...
          {/* About Section */}
          <div>
            <h3 className="text-sm text-gray-500 mb-3">SOLGATES</h3>
            <ul className="space-y-2 text-xs">
          ...
          {/* Socials Section */}
          <div>
            <h3 className="text-sm text-gray-600 mb-3">SOCIALS</h3>
