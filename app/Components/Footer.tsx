...
const Footer: React.FC = () => {
  return (
    <footer className="font-medium py-4 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-screen-lg mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {/* Shop Section */}
          <div className="lg:ml-14">
            <h3 className="text-xs text-gray-600 mb-2">SHOP</h3>
          ...
          <div>
            <h3 className="text-xs text-gray-500 mb-2">CUSTOMER SERVICE</h3>
            <ul className="space-y-1 text-xs">
          ...
          {/* About Section */}
          <div>
            <h3 className="text-xs text-gray-500 mb-2">SOLGATES</h3>
            <ul className="space-y-1 text-xs">
          ...
          <div className="lg:mr-8">
            <h3 className="text-xs text-gray-600 mb-2">SOCIALS</h3>
            <div className="flex text-xs mt-4 space-x-2">
            ...
            {/* Copyright */}
            <div className="text- text-xs mt-4 text-gray-500">
